...
<section id="slam" class="proj">
    <h3>Notre slam :</h3>
    <div class="slamContent">
        <audio controls src="public/sounds/Slam.wav" id="audio"></audio>
        <p id="textSlam">
...
<section id="video" class="proj">
    ...
    <div id="short-sheet">
        <p id="textVideo">
            ...
            une révolte placée sous le signe de la sororité ?<br>
...
<section id="lycee" class="proj">
    <p>
        <strong>Visiter des lycées de France</strong> pour sensibiliser les jeunes au harcèlement de rue, répondre à leurs questions, etc…
    </p>
